  ...
  competences: [
    {
      id: "developper",
      titre: "Développer",
      sousTitre: "<b>Développer pour le web et les médias numériques</b> (année 3). Une application complète, et plusieurs réalisations concrètes sur un site professionnel.",
      ...
      traces: [
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/cineaste-1.png", alt: "Liste de films" }, { src: "./public/img/cineaste-2.png", alt: "Fiche détaillée" } ] },
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/grille-intervenants.jpg", alt: "Grille d'intervenants" }, { src: "./public/img/speaker-carrosel.PNG", alt: "Carrousel d'orateurs" } ] },
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/bandeau-deroulant.png", alt: "Section d'accueil du site" } ] },
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/fr.jpg", alt: "Version française" }, { src: "./public/img/en.jpg", alt: "Version anglaise" } ] },
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/mobile.png", alt: "Affichage mobile" }, { src: "./public/img/ordi.jpg", alt: "Affichage ordinateur" } ] },
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/py-script.png", alt: "Script Python" }, { src: "./public/img/csv-python.png", alt: "Visuel généré" } ] },
    ...
    },
    {
      ...
      traces: [
        ...
        },
        {
          ...
          media: { type: "images", images: [ { src: "./public/img/programme.png", alt: "Page programme" }, { src: "./public/img/speakers.png", alt: "Page intervenants" }, { src: "./public/img/exposants.png", alt: "Page exposants" } ] },
        ...
        },
        {
          ...
          competence: "Entreprendre", niveau: "N3", ac: "Gestion de projet client", tags: [],
          media: { type: "images", images: [ { src: "./public/img/accueil.png", alt: "Page d'accueil en ligne" } ] },
        ...
        },
        {
          ...
          competence: "Entreprendre", niveau: "N3", ac: "Gestion de projet client", tags: [],
          media: { type: "images", images: [ { src: "./public/img/contact.png", alt: "Formulaire de contact" } ] },
